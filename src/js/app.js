...
const makeAutoClickerButton = (generateAutoClicker, displayAutoClicker, displayAutoPrice, dM) => {
...
makeAutoClickerButton(generateAutoClicker, displayAutoClicker, displayAutoPrice, donutMaker);
